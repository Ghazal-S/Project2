...
main(void)
{
  ...
  exit();
  16:	e8 b7 02 00 00       	call   2d2 <exit>
  1b:	66 90                	xchg   %ax,%ax
  1d:	66 90                	xchg   %ax,%ax
  1f:	90                   	nop
  ...
  34:	bb 0a 00 00 00       	mov    $0xa,%ebx
{
  ...
  4c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        if(fork() == 0) 
  50:	e8 75 02 00 00       	call   2ca <fork>
  55:	85 c0                	test   %eax,%eax
  57:	74 0a                	je     63 <frrTest+0x33>
  for(int i=0;i<10;i++) // loop will run 10 times
  59:	83 eb 01             	sub    $0x1,%ebx
  5c:	75 f2                	jne    50 <frrTest+0x20>
}
  5e:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  61:	c9                   	leave  
  62:	c3                   	ret    
	    printf(1, "%d ,  ", getpid());
  63:	e8 fa 02 00 00       	call   362 <getpid>
  68:	83 ec 04             	sub    $0x4,%esp
  6b:	50                   	push   %eax
  6c:	68 91 07 00 00       	push   $0x791
  71:	6a 01                	push   $0x1
 ...
 198:	89 f3                	mov    %esi,%ebx
{
 ...
 1b0:	50                   	push   %eax
 1b1:	6a 00                	push   $0x0
 1b3:	e8 42 01 00 00       	call   2fa <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 21d:	e8 00 01 00 00       	call   322 <open>
  if(fd < 0)
 ...
 231:	50                   	push   %eax
 232:	e8 03 01 00 00       	call   33a <fstat>
  close(fd);
 237:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 23a:	89 c6                	mov    %eax,%esi
  close(fd);
 23c:	e8 c9 00 00 00       	call   30a <close>
  return r;
 ...
 399:	85 d2                	test   %edx,%edx
{
 ...
 3c7:	f7 f1                	div    %ecx
 3c9:	0f b6 92 a0 07 00 00 	movzbl 0x7a0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	e9 8f fe ff ff       	jmp    478 <printf+0x48>
          s = "(null)";
 5e9:	bb 98 07 00 00       	mov    $0x798,%ebx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 6ee:	56                   	push   %esi
 6ef:	e8 7e fc ff ff       	call   372 <sbrk>
  if(p == (char*)-1)
