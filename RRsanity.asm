  ...
  24:	31 db                	xor    %ebx,%ebx
{
  ...
  30:	e8 9d 03 00 00       	call   3d2 <getpid>
  35:	53                   	push   %ebx
  36:	50                   	push   %eax
  for (i=0;i<1000;i++){
  ...
  3f:	6a 02                	push   $0x2
  41:	e8 5a 04 00 00       	call   4a0 <printf>
  for (i=0;i<1000;i++){
...
00000060 <RRsanity>:
{
  ...
  63:	53                   	push   %ebx
  printf(1, "RRsanity\n");
  64:	bb 0a 00 00 00       	mov    $0xa,%ebx
{
  69:	83 ec 1c             	sub    $0x1c,%esp
  printf(1, "RRsanity\n");
  6c:	68 1c 08 00 00       	push   $0x81c
  71:	6a 01                	push   $0x1
  ...
  7c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    pid = fork ();
  80:	e8 b5 02 00 00       	call   33a <fork>
    if ( pid < 0 ) {
  85:	85 c0                	test   %eax,%eax
  87:	78 42                	js     cb <RRsanity+0x6b>
    } else if (pid == 0) {
  89:	74 58                	je     e3 <RRsanity+0x83>
  for ( k = 0; k < 10; k++ ) {
  8b:	83 eb 01             	sub    $0x1,%ebx
  8e:	75 f0                	jne    80 <RRsanity+0x20>
  90:	bb 0a 00 00 00       	mov    $0xa,%ebx
  95:	8d 76 00             	lea    0x0(%esi),%esi
    wait();
  98:	e8 ad 02 00 00       	call   34a <wait>
  for (k = 0; k < 10; k++) {
  9d:	83 eb 01             	sub    $0x1,%ebx
  a0:	75 f6                	jne    98 <RRsanity+0x38>
    getPerformanceData(&wTime,&rTime);
  a2:	50                   	push   %eax
  a3:	50                   	push   %eax
  a4:	8d 45 f4             	lea    -0xc(%ebp),%eax
  a7:	50                   	push   %eax
  a8:	8d 45 f0             	lea    -0x10(%ebp),%eax
  ab:	50                   	push   %eax
  ac:	e8 a1 02 00 00       	call   352 <getPerformanceData>
    printf(1, "wTime: %d rTime: %d \n",wTime,rTime);
  b1:	ff 75 f4             	pushl  -0xc(%ebp)
  b4:	ff 75 f0             	pushl  -0x10(%ebp)
  b7:	68 3a 08 00 00       	push   $0x83a
  bc:	6a 01                	push   $0x1
  be:	e8 dd 03 00 00       	call   4a0 <printf>
    exit();
  c3:	83 c4 20             	add    $0x20,%esp
  c6:	e8 77 02 00 00       	call   342 <exit>
      printf(1, "%d failed in fork!\n", getpid());
  cb:	e8 02 03 00 00       	call   3d2 <getpid>
  d0:	52                   	push   %edx
  d1:	50                   	push   %eax
  d2:	68 26 08 00 00       	push   $0x826
  d7:	6a 01                	push   $0x1
  d9:	e8 c2 03 00 00       	call   4a0 <printf>
      exit();
  de:	e8 5f 02 00 00       	call   342 <exit>
      foo();
  e3:	e8 38 ff ff ff       	call   20 <foo>
      exit();
  e8:	e8 55 02 00 00       	call   342 <exit>
  ed:	66 90                	xchg   %ax,%ax
  ef:	90                   	nop
...
000004a0 <printf>:
 ...
 659:	bb 50 08 00 00       	mov    $0x850,%ebx
