...
00000020 <foo>:
{
  ...
  44:	81 fb e8 03 00 00    	cmp    $0x3e8,%ebx
  4a:	75 e4                	jne    30 <foo+0x10>
}
  4c:	8d 65 f8             	lea    -0x8(%ebp),%esp
  4f:	5b                   	pop    %ebx
  50:	5e                   	pop    %esi
  51:	5d                   	pop    %ebp
  52:	c3                   	ret    
...
00000060 <RRsanity>:
{
  ...
  64:	53                   	push   %ebx
  printf(1, "RRsanity\n");
  65:	bb 0a 00 00 00       	mov    $0xa,%ebx
{
  6a:	83 ec 18             	sub    $0x18,%esp
  printf(1, "RRsanity\n");
  6d:	68 1c 08 00 00       	push   $0x81c
  72:	6a 01                	push   $0x1
  ...
  90:	8d 45 f4             	lea    -0xc(%ebp),%eax
  93:	83 ec 08             	sub    $0x8,%esp
  96:	50                   	push   %eax
  97:	8d 45 f0             	lea    -0x10(%ebp),%eax
  9a:	50                   	push   %eax
  9b:	e8 b2 02 00 00       	call   352 <getPerformanceData>
    printf(1, "wTime: %d rTime: %d \n",wTime,rTime);
  a0:	ff 75 f4             	pushl  -0xc(%ebp)
  a3:	ff 75 f0             	pushl  -0x10(%ebp)
  a6:	68 26 08 00 00       	push   $0x826
  ab:	6a 01                	push   $0x1
  ...
  bb:	c3                   	ret    
	    foo(getpid()); 
  bc:	e8 11 03 00 00       	call   3d2 <getpid>
  ...
  dc:	81 fe e8 03 00 00    	cmp    $0x3e8,%esi
  e2:	75 e4                	jne    c8 <RRsanity+0x68>
            exit(); 
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	e9 8f fe ff ff       	jmp    4e8 <printf+0x48>
          s = "(null)";
 659:	bb 3c 08 00 00       	mov    $0x83c,%ebx
        while(*s != 0){
