 ...
 118:	89 f3                	mov    %esi,%ebx
{
 ...
 130:	50                   	push   %eax
 131:	6a 00                	push   $0x0
 133:	e8 42 01 00 00       	call   27a <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 19d:	e8 00 01 00 00       	call   2a2 <open>
  if(fd < 0)
 ...
 1b1:	50                   	push   %eax
 1b2:	e8 03 01 00 00       	call   2ba <fstat>
  close(fd);
 1b7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 1ba:	89 c6                	mov    %eax,%esi
  close(fd);
 1bc:	e8 c9 00 00 00       	call   28a <close>
  return r;
...
000002ea <getppid>:
SYSCALL(getppid)
 2ea:	b8 18 00 00 00       	mov    $0x18,%eax
 2ef:	cd 40                	int    $0x40
 2f1:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 66e:	56                   	push   %esi
 66f:	e8 7e fc ff ff       	call   2f2 <sbrk>
  if(p == (char*)-1)
