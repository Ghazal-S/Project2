...
main(void)
{
  ...
  exit();
  16:	e8 67 03 00 00       	call   382 <exit>
  1b:	66 90                	xchg   %ax,%ax
  1d:	66 90                	xchg   %ax,%ax
  1f:	90                   	nop
  ...
  44:	74 29                	je     6f <foo+0x4f>
{
  ...
  59:	6a 01                	push   $0x1
  5b:	e8 80 04 00 00       	call   4e0 <printf>
  for (i=0;i<500;i++){
  ...
  6e:	c3                   	ret    
	nice();
  6f:	e8 26 03 00 00       	call   39a <nice>
	nice();
  74:	e8 21 03 00 00       	call   39a <nice>
  ...
  84:	31 db                	xor    %ebx,%ebx
{
  ...
  a7:	74 6a                	je     113 <Sanity+0x93>
  for(int i=0;i<30;i++) 
  a9:	83 c3 01             	add    $0x1,%ebx
  ac:	83 fb 1e             	cmp    $0x1e,%ebx
  af:	75 ef                	jne    a0 <Sanity+0x20>
    getPerformanceData(&wTime,&rTime);
  b1:	8d 45 f4             	lea    -0xc(%ebp),%eax
  b4:	83 ec 08             	sub    $0x8,%esp
  b7:	50                   	push   %eax
  b8:	8d 45 f0             	lea    -0x10(%ebp),%eax
  bb:	50                   	push   %eax
  bc:	e8 d1 02 00 00       	call   392 <getPerformanceData>
    printf(1, "average wTime: %d average rTime: %d \n",(wTime/30),(rTime/30));
  c1:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  c4:	b9 89 88 88 88       	mov    $0x88888889,%ecx
  c9:	89 d8                	mov    %ebx,%eax
  cb:	f7 e9                	imul   %ecx
  cd:	01 da                	add    %ebx,%edx
  cf:	c1 fb 1f             	sar    $0x1f,%ebx
  d2:	c1 fa 04             	sar    $0x4,%edx
  d5:	29 da                	sub    %ebx,%edx
  d7:	8b 5d f0             	mov    -0x10(%ebp),%ebx
  da:	52                   	push   %edx
  db:	89 d8                	mov    %ebx,%eax
  dd:	f7 e9                	imul   %ecx
  df:	01 da                	add    %ebx,%edx
  e1:	c1 fb 1f             	sar    $0x1f,%ebx
  e4:	c1 fa 04             	sar    $0x4,%edx
  e7:	29 da                	sub    %ebx,%edx
  e9:	52                   	push   %edx
  ea:	68 50 08 00 00       	push   $0x850
  ef:	6a 01                	push   $0x1
  f1:	e8 ea 03 00 00       	call   4e0 <printf>
    printf(1, "total wTime: %d total rTime: %d \n",wTime,rTime);
  f6:	83 c4 20             	add    $0x20,%esp
  f9:	ff 75 f4             	pushl  -0xc(%ebp)
  fc:	ff 75 f0             	pushl  -0x10(%ebp)
  ff:	68 78 08 00 00       	push   $0x878
 104:	6a 01                	push   $0x1
 106:	e8 d5 03 00 00       	call   4e0 <printf>
}
 ...
 116:	53                   	push   %ebx
 117:	e8 04 ff ff ff       	call   20 <foo>
            exit(); 
...
printf(int fd, const char *fmt, ...)
{
 ...
 694:	e9 8f fe ff ff       	jmp    528 <printf+0x48>
          s = "(null)";
 699:	bb 9c 08 00 00       	mov    $0x89c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b1:	a1 9c 0b 00 00       	mov    0xb9c,%eax
{
 ...
 6ed:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6ef:	a3 9c 0b 00 00       	mov    %eax,0xb9c
}
 6f4:	5b                   	pop    %ebx
 6f5:	5e                   	pop    %esi
 6f6:	5f                   	pop    %edi
 ...
 706:	72 ce                	jb     6d6 <free+0x26>
{
 ...
 727:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 72a:	a3 9c 0b 00 00       	mov    %eax,0xb9c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 15 9c 0b 00 00    	mov    0xb9c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 47                	jae    7d8 <malloc+0x98>
    ...
    if(p == freep)
 791:	39 05 9c 0b 00 00    	cmp    %eax,0xb9c
 ...
 7b6:	e8 f5 fe ff ff       	call   6b0 <free>
  return freep;
 7bb:	8b 15 9c 0b 00 00    	mov    0xb9c,%edx
 ...
 7e4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7e7:	89 15 9c 0b 00 00    	mov    %edx,0xb9c
}
 ...
 807:	0b 00 00 
 80a:	c7 05 a0 0b 00 00 a0 	movl   $0xba0,0xba0
 811:	0b 00 00 
    base.s.size = 0;
 814:	b8 a0 0b 00 00       	mov    $0xba0,%eax
