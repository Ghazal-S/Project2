  ...
  1c:	31 db                	xor    %ebx,%ebx
{
  ...
  a2:	50                   	push   %eax
  a3:	e8 3a 03 00 00       	call   3e2 <open>
...
//    printf(fd, "%d\n", i);
  ...
  b8:	56                   	push   %esi
  b9:	57                   	push   %edi
  ba:	e8 03 03 00 00       	call   3c2 <write>
  for(i = 0; i < 20; i++)
  ...
  ca:	57                   	push   %edi
  cb:	e8 fa 02 00 00       	call   3ca <close>
  ...
  ee:	e8 ef 02 00 00       	call   3e2 <open>
 ...
 108:	56                   	push   %esi
 109:	57                   	push   %edi
 10a:	e8 ab 02 00 00       	call   3ba <read>
  for (i = 0; i < 20; i++)
 ...
 11a:	57                   	push   %edi
 11b:	e8 aa 02 00 00       	call   3ca <close>
 ...
 258:	89 f3                	mov    %esi,%ebx
{
 ...
 270:	50                   	push   %eax
 271:	6a 00                	push   $0x0
 273:	e8 42 01 00 00       	call   3ba <read>
    if(cc < 1)
...
malloc(uint nbytes)
{
 ...
 7ae:	56                   	push   %esi
 7af:	e8 7e fc ff ff       	call   432 <sbrk>
  if(p == (char*)-1)
